...
const scenarios = [
  {
    ...
    option1: "Patient often has headaches.",
    option2: "Patient doesn't often have headaches.",
    picture: headache,
  },
  {
    question: "Is your appetite poor?",
    option1: "Patient's appetite is poor.",
    option2: "Patient's appetite is not poor.",
    picture: poorApe,
  },
  {
    question: "Do you sleep badly?",
    option1: "Patient sleeps badly.",
    option2: "Patient doesn't sleep badly.",
    picture: sleep,
  },
  {
    question: "Are you easily frightened?",
    option1: "Patient is easily frightened.",
    option2: "Patient is not easily frightened.",
    picture: fright,
  },
  {
    question: "Do your hands shake?",
    option1: "Patient's hands shake.",
    option2: "Patient's hands don't shake.",
    picture: shakingHands,
  },
  {
    question: "Do you feel nervous, tense, or worried?",
    option1: "Patient feels nervous, tense, or worried.",
    option2: "Patient doesn't feel nervous, tense, or worried.",
    picture: nervousness,
  },
  {
    question: "Is your digestion poor?",
    option1: "Patient's digestion is poor.",
    option2: "Patient's digestion is not poor.",
    picture: digestion,
  },
  {
    question: "Do you have trouble thinking clearly?",
    option1: "Patient has trouble thinking clearly.",
    option2: "Patient doesn't have trouble thinking clearly.",
    picture: clearThinking,
  },
  {
    question: "Do you feel unhappy?",
    option1: "Patient feels unhappy.",
    option2: "Patient doesn't feel unhappy.",
    picture: unhappiness,
  },
  {
    question: "Do you cry more than usual?",
    option1: "Patient cries more than usual.",
    option2: "Patient doesn't cry more than usual.",
    picture: crying,
  },
];
